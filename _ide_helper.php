...
')
     ...
     */ 
         ...
         * 
         *
         * @see \PostScripton\Money\MoneyServiceProvider::packageBooted()
         * @param string $column
         * @static 
         */ 
        public static function money($column = 'amount')
        {
         ...
         * @static 
         */ 
        public static function unsignedMoney($column = 'amount')
        {
                        return \Illuminate\Database\Schema\Blueprint::unsignedMoney($column);
        }
